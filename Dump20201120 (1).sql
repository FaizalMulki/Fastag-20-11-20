...
CREATE TABLE `recharge` (
  ...
  `txnDateTime` varchar(155) DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
BEGIN
SELECT r.*,v.Type as VehicleType,s.Name as StatusName from fastag.registration r
inner join fastag.vehicletype v on v.Id=r.VehicleTypeId
inner join fastag.status s on s.Id=r.StatusId
where  r.Id=Id and r.isdeleted=0 ;
END ;;
...
-- Dump completed on 2020-11-20 17:05:56
